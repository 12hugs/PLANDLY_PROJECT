			...
			<div class="sign-up-container">
				...
				<form class="login-form" action="MemberJoin" method="post">
					...
					<div class="join-box">
						...
						<!-- 중복체크!! -->
						<div class="memcheck" style="display: flex; justify-content: center;">
							<button type="button" id="btnemailcheck">중복체크</button>
						</div>
						<div>
						...
						<div class="btn-group" role="group"
							...
							<input type="radio" class="btn-secondary" name="gender" value="male"
								id="btnradio1" autocomplete="off" checked="true"> <label
								class="btn btn-outline-primary btn-block" for="btnradio1">남</label> 
							<input type="radio" class="btn-secondary" name="gender" value="female"
								id="btnradio2" autocomplete="off"> <label
								class="btn btn-outline-primary btn-block" for="btnradio2">여</label>
						</div>
						<div>
					...
					<input class="form_btn join" type="submit" value="회원가입" style="color: white;">
				</form>
			</div>
			...
			<div class="sign-in-container">
				...
				<form action="MemberJoin" method="post">
					...
					<span>or use your account</span> <input type="email"
						...
						class="form_btn login" type="submit" value="로그인" onclick="" style="color: white;">
				</form>
			</div>
