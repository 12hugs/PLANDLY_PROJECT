...
public class MemberJoin extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		if (pw.trim().isEmpty() || email.trim().isEmpty()) {
			Map<String, Object> mySession = new HashMap<>();
			String errorMessage = "알맞은 값을 입력해 주세요";
			mySession.put("errorMessage", errorMessage);
		...
		if(age != null || gender != null || nickName != null) {
			
			joinCnt = dao.join(new Plandly_MemberVO(email, pw, age, gender, nickName));
		}
