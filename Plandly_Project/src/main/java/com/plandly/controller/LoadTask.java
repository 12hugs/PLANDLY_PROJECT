...
public class LoadTask extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		String cate = calendar.getCate();
		String is_public = calendar.getIs_public();
		...
		if (tasks != null) {
			...
			responseMap.put("cate", cate); // 응답에 cate 값 추가
			responseMap.put("is_public", is_public);  // 응답에 is_public 값 추가
