...
public class CalendarDAO {
	...
	public List<CalendarDTO> getEvents(String returnEmail) {

		SqlSession sqlSession = sqlSessionFactory.openSession();

		List<CalendarDTO> events = sqlSession.selectList("com.plandly.db.CalMapper.GetAllEvents", returnEmail);
	...
	public List<CalendarDTO> getHostEvents(String returnEmail) {
		
		SqlSession sqlSession = sqlSessionFactory.openSession();
		
		List<CalendarDTO> events = sqlSession.selectList("com.plandly.db.CalMapper.GetHostAllEvents", returnEmail);
	...
	public int UpPublicCal(CalendarDTO dto) {
		
		SqlSession sqlSession = sqlSessionFactory.openSession(true);
		
		int cnt = sqlSession.update("com.plandly.db.CalMapper.UpPublicCal", dto);
