		...
		<div class="container">
				...
				<form class="login-form" action="MemberJoin" method="post">
					...
					<div class="join-box">
						...
						<div class="memcheck" style="display: flex; justify-content: center;">
							<button type="button" class="btn btn-outline-secondary">중복체크</button>
						</div>
						<div>
						...
						<div id="btn-group" role="group"
							...
							<input
              class="btn btn-outline-secondary btn-ms" name="gender" value="남">
							<input
              class="btn btn-outline-secondary btn-ms" name="gender" value="여">
						</div>
						<div>
			...
			<div class="sign-in-container">
				...
				<form action="MemberJoin" method="post">
					...
					<span>간편로그인</span> <input type="email"
